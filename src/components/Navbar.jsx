...
//   return (
//     <nav className={`
//       sticky top-0  z-50 flex items-center justify-between px-10 py-5 bg-white transition-all duration-300
//        ${isScrolled ?"border-b border-gray-200 shadow-sm ": "border-b border-transparent"}`}>
//       <div className="navbar-logo flex items-center justify-center" onClick={() => setCurrentPage('home')}>
...
// </svg>
//      <h1 className="tracking-normal text-3xl font-extrabold">Cart<span>ify</span></h1>
//       </div>
